...
public class SystemArchitecture {
  ...
  @Pointcut("execution(* com.wangfengbabe.learning_spring.aop.java_style_configuration.service.IAccountService.*(..))")
  public void anyOperationInAccountService() {

  }

  //the execution of any method defined in the service package:
  @Pointcut("execution(* com.wangfengbabe.learning_spring.aop.java_style_configuration.service.*.*(..))")
