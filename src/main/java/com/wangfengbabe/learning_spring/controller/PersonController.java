...
import com.wangfengbabe.learning_spring.model.Person;
import com.wangfengbabe.learning_spring.model.XmlActionResult;
 ...
 */
@Controller @RequestMapping("/mvc") public class PersonController {

    @RequestMapping("/helloXmlPerson/{name}") @ResponseBody
